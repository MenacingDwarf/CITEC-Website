...
public class Example {
    ...
    private static LinkedHashMap toMap(String data) throws IOException {
        ObjectMapper mapper = new ObjectMapper();
        return mapper.readValue(data, new TypeReference<LinkedHashMap>(){});
    }

    public static List<MetricGroup> convert(LinkedHashMap map) throws IOException {
        return null;
    }

    public static void main(String[] args) throws IOException {
        LinkedHashMap map = toMap(data);
        convert(map);
    }
}
