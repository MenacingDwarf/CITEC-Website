...
var run = function() {
  ...
  var title = makeElement('div', 'title-of-project', project.title);
  ...
  customer.textContent += project.customer_link;
  ...
  var project_desc = makeElement('p', 'description', project.about_project);
